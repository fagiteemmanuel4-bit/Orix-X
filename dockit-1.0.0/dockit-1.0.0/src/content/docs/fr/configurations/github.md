...
description: Configurez l'intégration GitHub pour votre site de documentation Orix
sidebar:
  order: 5
  label: "[github] Intégration GitHub"
---

Connectez votre site de documentation Orix avec GitHub pour activer les fonctionnalités d'édition collaborative et de contrôle de version.
