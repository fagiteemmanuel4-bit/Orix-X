...
description: Learn how to add custom CSS styles and JavaScript functionality to your Orix documentation site.
sidebar:
  order: 4
...
Orix allows you to easily add custom CSS styles and JavaScript functionality to enhance your documentation site's appearance and behavior. This guide covers various methods for implementing custom code.
...
This documentation provides a comprehensive guide for adding custom CSS and JavaScript to your Orix site, including practical examples and best practices for maintainable customization.