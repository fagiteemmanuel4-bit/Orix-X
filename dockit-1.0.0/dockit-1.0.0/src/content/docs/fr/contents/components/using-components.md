...
Orix offre plusieurs options de composants pour créer une documentation riche et interactive. Vous avez accès aux composants intégrés d'Astro Starlight ainsi qu'à une collection de composants personnalisés pré-construits.
...
## Composants pré-construits Orix

En plus des composants Starlight, Orix contient une collection de composants spécialement conçus pour les besoins de documentation. Tous ces composants se trouvent dans le dossier `user-components`.
