---
title: Quickstart
description: Configure Orix's global settings, theme options, and site-wide preferences.
---

Orix provides flexible global configuration options to customize your documentation site's appearance, behavior, and functionality. This guide covers all the essential settings you can configure.

## Configuration Files

Orix uses several configuration files located in the `src/config/` directory:
...
```json
{
  ...
  "metadata": {
    "meta_author": "Orix Team",
    "meta_image": "/images/og-image.png",
    "meta_description": "Create beautiful documentation with Orix"
  }
}
```
...
Orix also integrates with Astro's configuration in `astro.config.mjs`:
