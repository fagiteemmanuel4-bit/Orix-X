...
description: Configure GitHub integration for your Orix documentation site
sidebar:
  order: 5
  label: "[github] GitHub Integration"
---

Connect your Orix documentation site with GitHub to enable collaborative editing and version control features.
