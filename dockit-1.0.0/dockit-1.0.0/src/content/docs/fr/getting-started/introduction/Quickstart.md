...
description: Configurez les paramètres globaux de Orix, les options de thème et les préférences à l'échelle du site.
---

Orix offre des options de configuration globale flexibles pour personnaliser l'apparence, le comportement et les fonctionnalités de votre site de documentation. Ce guide couvre tous les paramètres essentiels que vous pouvez configurer.

## Fichiers de configuration

Orix utilise plusieurs fichiers de configuration situés dans le répertoire `src/config/`:
...
```json
{
  ...
  "metadata": {
    "meta_author": "Équipe Orix",
    "meta_image": "/images/og-image.png",
    "meta_description": "Créez une belle documentation avec Orix"
  }
}
```
...
Orix integreert ook met Astro's configuratie in `astro.config.mjs`:
