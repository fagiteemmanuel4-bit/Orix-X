...
Orix provides multiple component options for building rich, interactive documentation. You have access to both Astro Starlight's built-in components and a collection of custom premade components.
...
## Orix Premade Components

In addition to Starlight components, Orix includes a collection of custom-built components designed specifically for documentation needs. All these components are located in the `user-components` folder.
