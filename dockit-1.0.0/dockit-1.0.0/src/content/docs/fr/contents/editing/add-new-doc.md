...
description: Apprenez à créer et organiser de nouvelles pages de documentation dans votre site Orix.
---

# Ajouter de nouvelles pages de documentation

Ce guide vous accompagne dans le processus d'ajout de nouvelles pages de documentation à votre site Orix, leur organisation correcte et la garantie qu'elles apparaissent dans la navigation.
...
Orix gebruikt Astro's content collections. Je kunt schema validatie toevoegen door `src/content/config.ts` te bewerken:
