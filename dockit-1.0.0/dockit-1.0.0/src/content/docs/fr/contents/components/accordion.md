...
<Accordion 
  question="Qu'est-ce que Orix?" 
  answer="Orix est un thème de documentation moderne construit avec Astro et Starlight." 
/>
```
...
<Accordion 
  ...
  answer="Voer npm install uit om te beginnen met Orix." 
/>
