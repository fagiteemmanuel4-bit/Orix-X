...
description: Apprenez à ajouter des styles CSS personnalisés et des fonctionnalités JavaScript à votre site de documentation Orix.
sidebar:
  order: 4
  label: "[node] CSS & JavaScript personnalisés"
---

Orix vous permet d'ajouter facilement des styles CSS personnalisés et des fonctionnalités JavaScript pour améliorer l'apparence et le comportement de votre site de documentation. Ce guide couvre différentes méthodes pour implémenter du code personnalisé.

## CSS personnalisé

### Ajouter des styles globaux

Vous pouvez ajouter des styles CSS globaux qui s'appliquent à toutes les pages de votre site de documentation.

#### Méthode 1: Utilisation de la configuration du thème

Ajoutez votre CSS personnalisé au fichier de configuration du thème:
...
#### Méthode 2: Injection CSS directe

Créez un fichier CSS dans votre répertoire `src/styles/`:
...
/* Style de composant personnalisé */
.custom-card {
...
Vous pouvez également ajouter des styles spécifiques à certains composants:

```css
/* Personnalisations de navigation */
.sidebar-nav {
...
Deze documentatie biedt een uitgebreide gids voor het toevoegen van aangepaste CSS en JavaScript aan je Orix site, inclusief praktische voorbeelden en beste praktijken voor onderhoudbare aanpassingen.